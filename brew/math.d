...
struct Math(T)
{
    ...
    pure static T clamp(T value, T below, T above)
    {
        return clampAbove(clampBelow(value, below), above);
    }
    unittest
    {
    ...
    pure static T clampAbove(T value, T above)
    {
        return min(value, above);
    }
    pure static T clampBelow(T value, T below)
    {
        return max(value, below);
    }
    ...
    pure static T invMag2(T x, T y)
    {
        return inv(mag2(x, y));
    }

    pure static T mag2(T x, T y)
    {
        return sqrt(magSqr2(x, y));
    }

    pure static T magSqr2(T x, T y)
    {
        return sqr(x) + sqr(y);
    }

    pure static T invMag3(T x, T y, T z)
    {
        return inv(mag3(x, y, z));
    }

    pure static T mag3(T x, T y, T z)
    {
        return sqrt(magSqr3(x, y, z));
    }

    pure static T magSqr3(T x, T y, T z)
    {
        return sqr(x) + sqr(y) + sqr(z);
    }

    pure static T invMag4(T x, T y, T z, T w)
    {
        return inv(mag4(x, y, z, w));
    }

    pure static T mag4(T x, T y, T z, T w)
    {
        return sqrt(magSqr4(x, y, z, w));
    }

    pure static T magSqr4(T x, T y, T z, T w)
    {
        return sqr(x) + sqr(y) + sqr(z) + sqr(w);
    }

    pure static T invSqrt(T a)
    {
        return inv(sqrt(a));
    }
    unittest
    ...
    pure static T sqrt(T a)
    {
        return cast(T)std.math.sqrt(cast(real)a);
    }
    unittest
    {
    ...
    pure static T dot2(T x1, T y1, T x2, T y2)
    {
        return (x1 * x2) + (y1 * y2);
    }
    unittest
    ...
    {
        return cast(T)std.math.floor(cast(real)value);
    }
    static T ceil(T value)
    {
        return cast(T)std.math.ceil(cast(real)value);
    }
    static T round(T value)
    {
        return cast(T)std.math.round(cast(real)value);
    }

    pure static T mean(T v1, T v2)
    {
        return (v1 + v2) / 2;
    }
    ...
    pure static T pi()
    {
        return cast(T)std.math.PI;
    }

    pure static T pi2()
    {
        return cast(T)std.math.PI_2;
    }
    ...
    static T sin(T a)
    {
        return cast(T)std.math.sin(cast(real)a);
    }

    static T cos(T a)
    {
        return cast(T)std.math.cos(cast(real)a);
    }

    static T atan2(T y, T x)
    {
        return cast(T).std.math.atan2(cast(real)y, cast(real)x);
    }
    ...
    static pure T powerOf2(int number)
    {
        return powerOfN(number, 2);
    }

    static pure T powerOf3(int number)
    {
        return powerOfN(number, 3);
    }
    ...
    static pure T invPhi()
    {
        return cast(T)(1.0 / 1.618);
    }
    ...
    static pure T invSqrt2()
    {
        return inv(sqrt(2));
    }

    static T round(T val, T granularity)
    {
        return round(val / granularity) * granularity;
    }

    static T floor(T val, T granularity)
    {
        return floor(val / granularity) * granularity;
    }

    static T ceil(T val, T granularity)
    {
