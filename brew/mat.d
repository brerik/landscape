...
struct Mat(int R, int C, T)
{
    ...
    static if (C>=1)
    {
        pure VecRT col0() const
        {
            return c0;
        }
        void col0(in VecRT c)
        {
            c0 = c;
        }
    }
    ...
    static if (C>=2)
    {
        pure VecRT col1() const
        {
            return c1;
        }
        void col1(in VecRT c)
        {
            c1 = c;
        }
    }
    ...
    static if (C>=3)
    {
        pure VecRT col2() const
        {
            return c2;
        }
        void col2(in VecRT c)
        {
            c2 = c;
        }
    }
    ...
    static if (C>=4)
    {
        pure VecRT col3() const
        {
            return c3;
        }
        void col3(in VecRT c)
        {
            c3 = c;
        }
    }
    ...
    static if (R==2 && C==2)
    {
        pure Vec2T transform(in Vec2T v)
        {
            return transform(v, this);
        }
    }
    static if (R==3 && C==3)
    {
        pure Vec3T transform(in Vec3T v)
        {
            return transform(v, this);
        }
    }
    static if (R==4 && C==4)
    {
        pure Vec4T transform(in Vec4T v)
        {
            return transform(v, this);
        }
    }
